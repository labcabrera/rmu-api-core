...
const envSchema = z.object({
  ...
  RMU_MONGO_CORE_URI: z.string().min(1, "Required RMU_MONGO_CORE_URI"),
  ...
  RMU_KAFKA_BROKERS: z
    .string()
    .min(1, "RMU_KAFKA_BROKERS is required"),
  RMU_KAFKA_PARTITION_COUNT: z
    .coerce.number()
    .default(2),
  RMU_KAFKA_REPLICATION_FACTOR: z
    .coerce.number()
    .default(1),
  RMU_KAFKA_RETENTION_MS: z
    .coerce.number()
    .default(604800000), // 7 days
  RMU_KAFKA_COMPRESSION_TYPE: z
