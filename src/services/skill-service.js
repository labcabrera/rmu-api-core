const skills = [
    ...
    { 'id': "melee-weapon:hafted", categoryId: "combat-training", bonus: ["st"], specializations: null },
    { 'id': "melee-weapon:greater-blade", categoryId: "combat-training", bonus: ["st"], specializations: null },
    { 'id': "melee-weapon:greater-chain", categoryId: "combat-training", bonus: ["st"], specializations: null },
    { 'id': "melee-weapon:greater-hafted", categoryId: "combat-training", bonus: ["st"], specializations: null },
    { 'id': "melee-weapon:pole-arm", categoryId: "combat-training", bonus: ["st"], specializations: null },
    { 'id': "melee-weapon:exotic", categoryId: "combat-training", bonus: ["st"], specializations: null },

    { 'id': "ranged-weapon:bow", categoryId: "combat-training", bonus: ["ag"], specializations: null },
    { 'id': "ranged-weapon:crossbow", categoryId: "combat-training", bonus: ["ag"], specializations: null },
    { 'id': "ranged-weapon:sling", categoryId: "combat-training", bonus: ["ag"], specializations: null },
    { 'id': "ranged-weapon:thrown", categoryId: "combat-training", bonus: ["ag"], specializations: null },
    { 'id': "ranged-weapon:exotic", categoryId: "combat-training", bonus: ["ag"], specializations: null },
    ...
    { 'id': "control-lycanthropy", categoryId: "medical", bonus: ["sd"], specializations: null },
    { 'id': "meditation", categoryId: "medical", bonus: ["sd"], specializations: null },
    { 'id': "mental-focus", categoryId: "medical", bonus: ["sd"], specializations: null },
    ...
    { 'id': "power-development", categoryId: "power-manipulation", bonus: ["co"], specializations: null },
    { 'id': "power-projection", categoryId: "power-manipulation", bonus: ["sd"], specializations: null },
    ...
    { 'id': "ambus", categoryId: "subterfuge", bonus: ["in"], specializations: null },
